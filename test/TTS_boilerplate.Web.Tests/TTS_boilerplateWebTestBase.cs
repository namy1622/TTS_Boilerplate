...
{
    public abstract class TTS_boilerplateWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TTS_boilerplateWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TTS_boilerplateWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TTS_boilerplateDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TTS_boilerplateDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TTS_boilerplateDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TTS_boilerplateDbContext, Task<T>> func)
        {
            T result;
