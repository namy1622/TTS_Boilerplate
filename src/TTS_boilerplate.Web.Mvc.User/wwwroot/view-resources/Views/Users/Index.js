(function ($) {
    console.log(abp.services.app.user)
    ...
    var _$usersTable = _$table.DataTable({
        ...
        listAction: {
            ...
            inputFilter: function () {
                //console.log(_$usersTable)
                //console.log(_userService.getAll)
                console.warn('UsersSearchForm', $('#UsersSearchForm').serializeFormToObject(true))
