...
namespace TTS_boilerplate.Migrations
{
    ...
    [Migration("20250424183055_update_Order_v2")]
    partial class update_Order_v2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TTS_boilerplate.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TTS_boilerplate.Core.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TTS_boilerplate.Models.Task", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TTS_boilerplate.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("TTS_boilerplate.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("TTS_boilerplate.Authorization.Roles.Role", b =>
                {
                    b.HasOne("TTS_boilerplate.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("TTS_boilerplate.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("TTS_boilerplate.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TTS_boilerplate.Core.CartItem", b =>
                {
                    b.HasOne("TTS_boilerplate.Core.Cart", null)
                        .WithMany("CartItems")
                    ...
                    b.HasOne("TTS_boilerplate.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("TTS_boilerplate.Core.OrderItem", b =>
                {
                    ...
                    b.HasOne("TTS_boilerplate.Core.Order", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("TTS_boilerplate.Models.Product", b =>
                {
                    ...
                    b.Navigation("BelongToCategory");
                });

            modelBuilder.Entity("TTS_boilerplate.Models.Task", b =>
                {
                    b.HasOne("TTS_boilerplate.Models.Person", "AssignedPerson")
                        .WithMany()
