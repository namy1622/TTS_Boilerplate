...
namespace TTS_boilerplate.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = TTS_boilerplateConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
            return new List<ApplicationLanguage>
            {
                new ApplicationLanguage(tenantId, "vi", "VietNam", "famfamfam-flags-vn"),
        ...
        public DefaultLanguagesCreator(TTS_boilerplateDbContext context)
        {
            _context = context;
        }
